...
[experiment2 version]
1.generated attention vector and the output of lstm are directly concat and attached to a softmax layer

[Note]
this model is actually the same as the exp1/v1-one-weight
