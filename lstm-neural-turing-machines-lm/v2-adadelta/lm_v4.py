...
#		print "done compile"
	...
	def create_training_function(self):
		updates, _, _, _, _ = create_optimization_updates(self.lstm_cost, self.params, method="adadelta", lr=self.lstm_lr)
...
#		updates, _, _, _, _ = create_optimization_updates(self.cost, self.params, method="adadelta", lr=self.lr)
		...
		all_updates_lstm, _, _, _, _ = create_optimization_updates(self.final_cost, self.params, method="adadelta", lr=self.all_lr,part=True)
